...
@Autonomous(name="Blue Foundation Long", group = "auto")
...
public class foundationBlueTurn extends SkystoneLinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        turnPIDF(180, 0.8/90,0.0001,2, 4000);    //turn robot & foundation into wall
        ...
        driveAdjust(0, -0.7, 95, 2);  //back away from foundation
    }
}